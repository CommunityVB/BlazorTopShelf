...
Public Class Host
  ...
  Public Function Run(ServiceEvents As ServiceEvents) As ExitCodes
    Return Me.Run(ServiceEvents, Nothing)
  End Function
  ...
  ''' <param name="ServiceEvents">A set of actions to be invoked when the service is started and stopped.</param>
  ''' <returns>The TopShelf exit code.</returns>
  Public Function Run(ServiceEvents As ServiceEvents, HostEvents As HostEvents) As ExitCodes
    ...
    oFactory = Function(Settings) New Manager(oServiceEvents, Me)
